...
<body>
    <h1 class="h1">图片1</h1>
    <img class="img-rounded" src="${path}/resource/images/1.jpg">
    <h1 class="h1">图片2</h1>
    <img class="img-circle" src="${path}/resource/images/2.jpg">
    <h1 class="h1">图片3</h1>
    <img class="img-thumbnail" src="${path}/resource/images/3.jpg">
</body>
</html>
